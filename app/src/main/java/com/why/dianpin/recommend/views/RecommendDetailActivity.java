...
//        HttpUtil.create("recommend/getRecommendDetail")
//                .addParameter("recommendId", 3)
...
//                });
    ...
    public void refreshData() {
        final RecommendListBean travelDetail = getTravelBean();
        final RecommendDetailHeaderBean headerBean = new RecommendDetailHeaderBean();
        RecommendListBean.copy(headerBean, travelDetail);
